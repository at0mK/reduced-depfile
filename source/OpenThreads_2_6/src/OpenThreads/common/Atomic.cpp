...
bool
AtomicPtr::assign(void* ptrNew, void* ipaptrOld)
{
#if defined(_OPENTHREADS_ATOMIC_USE_GCC_BUILTINS)
    return __sync_bool_compare_and_swap(&_ptr, (void*)ipaptrOld, ptrNew);
#elif defined(_OPENTHREADS_ATOMIC_USE_WIN32_INTERLOCKED)
    return ipaptrOld == InterlockedCompareExchangePointer((PVOID volatile*)&_ptr, (PVOID)ptrNew, (PVOID)ipaptrOld);
#elif defined(_OPENTHREADS_ATOMIC_USE_BSD_ATOMIC)
